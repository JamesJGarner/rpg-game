...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Spell.type'
        db.add_column(u'match_spell', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['characters.Type'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Spell.type'
        db.delete_column(u'match_spell', 'type_id')
    ...
    models = {
        ...
        u'match.match': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resource': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'max_length': '200'})
        },
        u'match.spell': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['characters.Type']", 'null': 'True'})
        }
    }
