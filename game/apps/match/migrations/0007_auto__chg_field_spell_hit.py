...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Spell.hit'
        db.alter_column(u'match_spell', 'hit', self.gf('django.db.models.fields.IntegerField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Spell.hit'
        db.alter_column(u'match_spell', 'hit', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10))
