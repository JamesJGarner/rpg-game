...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Spell.turn_cooldown'
        db.add_column(u'match_spell', 'turn_cooldown',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Spell.turn_cooldown'
        db.delete_column(u'match_spell', 'turn_cooldown')
