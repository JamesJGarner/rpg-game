...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Match.user'
        db.alter_column(u'match_match', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['characters.Character']))

    def backwards(self, orm):

        # Changing field 'Match.user'
        db.alter_column(u'match_match', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'match.match': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['characters.Character']"})
        }
    }
