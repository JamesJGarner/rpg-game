...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attack.damage_taken'
        db.add_column(u'match_attack', 'damage_taken',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3, max_length=200),
                      keep_default=False)


        # Changing field 'Attack.enemy_return_spell'
        db.alter_column(u'match_attack', 'enemy_return_spell_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['match.Spell']))

    def backwards(self, orm):
        # Deleting field 'Attack.attack_damage'
        db.delete_column(u'match_attack', 'attack_damage')

        # Deleting field 'Attack.damage_taken'
        db.delete_column(u'match_attack', 'damage_taken')


        # Changing field 'Attack.enemy_return_spell'
        db.alter_column(u'match_attack', 'enemy_return_spell_id', self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['match.Spell']))
    ...
    models = {
        ...
        u'match.attack': {
            ...
            'attack_damage': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '200'}),
            'damage_taken': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '200'}),
