...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Attack.hit'
        db.delete_column(u'match_attack', 'hit')

        # Adding field 'Attack.spell'
        db.add_column(u'match_attack', 'spell',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['match.Spell']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Attack.hit'
        db.add_column(u'match_attack', 'hit',
                      self.gf('django.db.models.fields.IntegerField')(default=3, max_length=10),
                      keep_default=False)

        # Deleting field 'Attack.spell'
        db.delete_column(u'match_attack', 'spell_id')
