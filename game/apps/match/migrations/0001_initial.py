...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Match'
        db.create_table(u'match_match', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('enemy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['enemies.Enemy'])),
            ('enemy_health', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=16, blank=True)),
            ('enemy_rip', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'match', ['Match'])


    def backwards(self, orm):
        # Deleting model 'Match'
        db.delete_table(u'match_match')
