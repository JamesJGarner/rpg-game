...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.resource'
        db.add_column(u'match_match', 'resource',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.resource'
        db.delete_column(u'match_match', 'resource')
