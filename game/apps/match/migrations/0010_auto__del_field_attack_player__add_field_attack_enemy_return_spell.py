...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Attack.player'
        db.delete_column(u'match_attack', 'player')

        # Adding field 'Attack.enemy_return_spell'
        db.add_column(u'match_attack', 'enemy_return_spell',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, related_name='reliation', to=orm['match.Spell']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Attack.player'
        db.add_column(u'match_attack', 'player',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Attack.enemy_return_spell'
        db.delete_column(u'match_attack', 'enemy_return_spell_id')
