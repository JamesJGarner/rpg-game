...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Attack.attack_damage'
        db.delete_column(u'match_attack', 'attack_damage')

        # Adding field 'Attack.damage_dealt'
        db.add_column(u'match_attack', 'damage_dealt',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=200, null=True),
                      keep_default=False)


        # Changing field 'Attack.damage_taken'
        db.alter_column(u'match_attack', 'damage_taken', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=200, null=True))

    def backwards(self, orm):
        # Adding field 'Attack.attack_damage'
        db.add_column(u'match_attack', 'attack_damage',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=3, max_length=200),
                      keep_default=False)

        # Deleting field 'Attack.damage_dealt'
        db.delete_column(u'match_attack', 'damage_dealt')


        # Changing field 'Attack.damage_taken'
        db.alter_column(u'match_attack', 'damage_taken', self.gf('django.db.models.fields.PositiveIntegerField')(default=3, max_length=200))
    ...
    models = {
        ...
        u'match.attack': {
            ...
            'damage_dealt': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '200', 'null': 'True'}),
            'damage_taken': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '200', 'null': 'True'}),
            'enemy_return_spell': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reliation'", 'null': 'True', 'to': u"orm['match.Spell']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'match.spell': {
            ...
            'turn_cooldown': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '200'})
        }
    }
