...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'characters_item', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.damage'
        db.add_column(u'characters_item', 'damage',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Item.healing'
        db.add_column(u'characters_item', 'healing',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Item.armor'
        db.add_column(u'characters_item', 'armor',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=200, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'characters_item', 'image')

        # Deleting field 'Item.damage'
        db.delete_column(u'characters_item', 'damage')

        # Deleting field 'Item.healing'
        db.delete_column(u'characters_item', 'healing')

        # Deleting field 'Item.armor'
        db.delete_column(u'characters_item', 'armor')
