...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InvBag'
        db.create_table(u'characters_invbag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('level_required', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=100)),
            ('worth', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=2)),
            ('spaces', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=100)),
        ))
        db.send_create_signal(u'characters', ['InvBag'])

        # Adding field 'Character.inv_bag'
        db.add_column(u'characters_character', 'inv_bag',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['characters.InvBag'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InvBag'
        db.delete_table(u'characters_invbag')

        # Deleting field 'Character.inv_bag'
        db.delete_column(u'characters_character', 'inv_bag_id')
    ...
    models = {
        ...
        u'characters.character_items': {
            'Meta': {'object_name': 'Character_Items'},
