...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Item'
        db.create_table(u'characters_item', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['characters.Group'])),
            ('worth', self.gf('django.db.models.fields.DecimalField')(max_digits=100, decimal_places=2)),
            ('for_class', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['characters.Type'])),
            ('level_required', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=200)),
        ))
        db.send_create_signal(u'characters', ['Item'])

        # Adding model 'Group'
        db.create_table(u'characters_group', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal(u'characters', ['Group'])


    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table(u'characters_item')

        # Deleting model 'Group'
        db.delete_table(u'characters_group')
