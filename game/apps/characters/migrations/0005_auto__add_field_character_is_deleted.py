...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.is_deleted'
        db.add_column(u'characters_character', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.is_deleted'
        db.delete_column(u'characters_character', 'is_deleted')
