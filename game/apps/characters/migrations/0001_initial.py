...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'characters_character', (
            ...
            ('xp', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=16, blank=True)),
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'Type'
        db.delete_table(u'characters_type')
